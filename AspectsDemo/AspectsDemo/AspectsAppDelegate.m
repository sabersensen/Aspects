...
//        } error:NULL];
        ...
        [AspectsViewController aspect_hookSelector:@selector(viewWillLayoutSubviews) withOptions:AspectPositionAfter usingBlock:^(id<AspectInfo> info){
            NSLog(@"Controller is layouting!%@",info);
        } error:NULL];
    }
